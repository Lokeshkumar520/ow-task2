...
async function create(body) {
    ...
    if (isAdmin) {
        ...
        return Response={ status: "Failed", message: "Admin is already registered as " + isAdmin.username };
    }
    ...
    return isSavedAdmin ?Response={ status: 'Success', message: 'Registered Admin' } :
    Response={ status: 'Failed', message: 'Admin Registration failed!' };
}

async function addDevice({ newDeviceName, newDeviceActions }) {
    const isDeviceExist = await Device.findOne({ deviceName: newDeviceName });
    if (isDeviceExist) {
        return Response={ status: 'Failed!', message: 'Device name already exist, Please try with different Name.' };
    }
    let newDevice = {
    ...
    try {
        ...
        return Response={ status: 'Success', message: 'New Device Added Successfully' };
    } catch (error) {
        return Response={ status: 'Failed', message: 'Failed to add new device Please try again!' };
    }
...
async function setDevicePowerOnOff(body) {
    ...
    if (isDevice) {
        ...
        try {
            ...
            return Response={ status: 'Success', message: 'Device Action Changed Successfully' };
        } catch (error) {
            console.error(error);
            return Response={ status: 'Failed', message: 'Error in Device Action, please try again' };
        }
    }
    return Response={ status: 'Failed', message: 'Device is not exist' };
}
...
async function deleteDevice(body) {
    ...
    if (isDevice) {
        ...
        return Response={ status: 'Success', message: isDevice.deviceName + ' Device deleted Successfully' };
    }
    return Response={ status: 'Failed', message: 'Device is not exist/already removed' };
}
...
async function deleteAllDevices() {
    ...
    if (isDevice) {
        ...
        return Response={ status: 'Success', message: 'All Device are deleted Successfully' };
    }
    return Response={ status: 'Failed', message: 'Devices not exist/already removed' };
...
async function getAllDevices() {
    ...
    if (isDevice) {
        ...
        return Response={ status: 'Success', message: 'All Device are deleted Successfully', deviceList:isDevice };
    }
    return Response={ status: 'Failed', message: 'Devices are not exist' };
}
